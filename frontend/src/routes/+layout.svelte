...
<div class="navbar bg-neutral text-neutral-content shadow-md sticky top-0 z-40 px-4">
  ...
  <div class="navbar-end flex items-center gap-1">
    <a href="/cart" class="btn btn-ghost btn-circle" title="Cart">
      <div class="indicator">
        ...
        {#if $cartCount > 0}
          <span class="badge badge-primary badge-sm indicator-item">{$cartCount}</span>
        {/if}
      </div>
    </a>
    <a href="/admin" class="btn btn-ghost btn-circle" title="Admin">
